        ...
        <div class="header-last-part mt-4">
            <div class="container pg-header">
                <div class="links p-4 d-flex justify-content-center align-items-center">
                    ...
                    <a class="fs-6 text-uppercase main-color text-decoration-none" href="">LOGIN</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="login section-padding">
        <div class="container p-0">
            <div class="w-100 row pg-header p-5 ">
                <form class="d-flex flex-column align-items-center justify-content-center" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                    ...
                    <input class="btn btn-outline-secondary mt-4 w-75" type="submit" name="Login" id="Login"
                        value="Login">
                </form>
                <div class="d-flex justify-content-center align-items-center mt-3">
                    <p class="secondary-color fs-5 me-2 m-0">or</p>
                    <a class="signup text-decoration-none secondary-color fs-4" href="signup.php"> signUp</a>
                </div>
            </div>
        </div>
    </section>
